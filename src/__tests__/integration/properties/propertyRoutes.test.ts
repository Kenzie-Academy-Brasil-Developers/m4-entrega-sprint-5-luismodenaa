...
describe("/properties", () => {
  ...
  test("POST /properties -  Must be able to create a property", async () => {
    ...
    expect(response.body.addressId).toHaveProperty("id");
    expect(response.body.addressId).toHaveProperty("district");
    expect(response.body.addressId).toHaveProperty("zipCode");
    expect(response.body.addressId).toHaveProperty("number");
    expect(response.body.addressId).toHaveProperty("city");
    expect(response.body.addressId).toHaveProperty("state");
